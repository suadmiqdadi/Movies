...
use Project\MoviesBundle\Form\MovieType;
...
class MovieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProjectMoviesBundle:Movie')->findAll();

        return $this->render('ProjectMoviesBundle:Movie:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ProjectMoviesBundle:Movie:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProjectMoviesBundle:Movie')->find($id);
        ...
        return $this->render('ProjectMoviesBundle:Movie:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ProjectMoviesBundle:Movie:edit.html.twig', array(
            'entity'      => $entity,
