...
use Project\MoviesBundle\Entity\Order;
use Project\MoviesBundle\Form\OrderType;
...
class OrderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProjectMoviesBundle:Order')->findAll();

        return $this->render('ProjectMoviesBundle:Order:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ProjectMoviesBundle:Order:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProjectMoviesBundle:Order')->find($id);
        ...
        return $this->render('ProjectMoviesBundle:Order:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ProjectMoviesBundle:Order:edit.html.twig', array(
            'entity'      => $entity,
